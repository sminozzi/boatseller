...
?>
   ...
   <div class="footer-column-three">
		...
		<?php endif; ?>
			...
			<div class="site-info">
				...
				<?php
					 ...
					 * Fires before the boatseller footer text for footer customization.

					 *

					 * @since Theme boat seller 1.0

					 */

					do_action( 'boatseller_credits' );

    $my_footer_copyright = get_theme_mod('boatseller_footer_copyright');

    if ( is_customize_preview() ) : ?>

        <span class="customize-partial-edit-shortcut">

        <button class="customizer-edit" data-control='{ "name":"boatseller_footer_copyright" } '>
    ...
    <?php endif; 
             ...
             { echo esc_html($my_footer_copyright); }

              else

              { echo  __('Powered by  BoatSellerTheme.com','boatseller'); }
...
<?php
  ...
  if (get_theme_mod('boatseller_back_to_top', '1') == '1')
  ...
  { ?>
    ...
    <?php _e( 'Back to Top', 'boatseller' ); ?></a>
